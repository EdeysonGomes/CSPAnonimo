...
The suggested tool for simulating the robot's identification module is **[SIMULATOR]**.  
...
### **3. Deliverables**  
A team member must submit the following by **[DATE]**, via the (LMS):  

1. A file for the **[SIMULATOR] simulator** containing the robot's identification module. 
...
5. Use the **[SIMULATOR]** tool to simulate the robot's identification process.  
