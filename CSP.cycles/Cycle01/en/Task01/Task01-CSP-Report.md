# Competency Specification Report: Task01 - Retail Vending System Scenario

## Introduction

Building on the foundational CSP methodology, this report presents the application of the **Competency Authoring phase** in **Task01 – Retail Vending System Scenario**, a Problem-Based Learning (PBL) scenario that explores the use of **finite automata and regular expressions** in the design of vending machine software and hardware solutions.
...
### Title
    ...
    Retail Vending System Scenario
...
- Simulate & validate using computational tools (e.g., [SIMULATOR]).
...
- Setting: Access to [SIMULATOR] or equivalent simulation tools
...
- **Simulation Tools**  
  - Involves the use of **automata simulation tools** (such as [SIMULATOR]) to validate and analyze **proposed solutions**.  
...
9. **Use finite automata simulation tools**  
   - Apply tools such as **[SIMULATOR]** to simulate, analyze, and verify the functionality of the designed automaton.
...
This competency refers to the ability to simulate and evaluate the behavior of computational models—such as Finite Automata, Pushdown Automata, and Turing Machines—using specialized tools like [SIMULATOR] or equivalent. It ensures that students can test automata-based solutions for correctness, completeness, and alignment with formal specifications.
