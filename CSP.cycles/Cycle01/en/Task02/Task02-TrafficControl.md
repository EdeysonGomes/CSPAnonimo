...
Additionally, there are already sensors installed at the entrance and exit of the Anonymous Road that allow vehicles to be identified and categorized. The technicians would like a solution that, based on the information from these sensors, **can determine how many vehicles from each category traveled during the previous night** and **identify which category had the most vehicles.**

The current cohort of the Theory of Computation class is studying Turing Machines and believes **they can design a system with such functionalities.** As a result, they contacted Domain stakeholders **to offer some solutions to this problem.**
...
You are required to upload to [LMS]  by **[DATE]**, in the designated area: 

1. One or more files containing **Turing Machines** (in [SIMULATOR] format) that provide a solution to the problem.
...
Develop Turing Machines to compute solutions for "real-world" problems, such as the Anonymous problem.
