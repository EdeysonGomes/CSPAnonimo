...
The suggested tool for simulating the robots' modules is **[SIMULATOR][^1]**.
...
1. A file for the **[SIMULATOR] simulator** containing the Farmer Robot's identification and navigation modules as well as the Feeder Robot's navigation module.  
...
5. Use the **[SIMULATOR]** tool to simulate the processes of the robots' modules.  
