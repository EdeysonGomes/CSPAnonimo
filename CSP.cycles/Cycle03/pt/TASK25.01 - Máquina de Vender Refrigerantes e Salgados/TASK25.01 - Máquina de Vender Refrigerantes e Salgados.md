...
Os estudantes também comentaram sobre uma ferramenta chamada **SIMULADOR**[^1] para testar/simular soluções que utilizam esses autômatos. Eles explicaram que a SIMULADOR apresenta uma interface gráfica que pode contribuir para a documentação dessas novas soluções para as máquinas de venda.
