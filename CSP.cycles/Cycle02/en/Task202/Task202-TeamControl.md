...
The student team from , responsible for developing the prototype, analyzed the new requirement and concluded that **a simple finite state machine is not sufficient to solve the problem**. This raises an important question: what factors led them to this conclusion?
...
One team member must submit, through the  Virtual Learning Environment (AVA), by **6:00 PM on 05/02/YEAR**, the following deliverables:

* A **[SIMULATOR] file** with the **drone surveillance and team control modules**.
...
3. Model and simulate system behavior in [SIMULATOR], ensuring compliance with institutional regulations.
...
7. Simulate and validate system behavior in [SIMULATOR], demonstrating compliance with operational requirements.
