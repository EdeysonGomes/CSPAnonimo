...
The team must submit a **report in SBC article format** containing all analyses and results. Submission is due via ** [LMS]** by **11:59 PM on 27/06/YEAR**. The report must include:
...
15. Implement and simulate the FSM in [SIMULATOR] to validate the model.

## Referências

**KIOTHEKA, Fernando; ALMEIDA, Raul.** *Introdução à Maratona de Programação*. v. 1.7YEAR.  
